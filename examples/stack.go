...
func main() {
	fmt.Println("---------- start of ExampleStackCaller")
	ExampleStackCaller()
	fmt.Println("---------- end of ExampleStackCaller\n")

	fmt.Println("---------- start of ExampleStackTrace")
	ExampleStackTrace()
	fmt.Println("---------- end of ExampleStackTrace\n")
}
